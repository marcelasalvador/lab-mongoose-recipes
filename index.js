...
//     return Recipe.findOneAndUpdate({duration: 220}, {$set:{duration:100}}, {new: true}, (err, doc) => {
//       if (err) {
//           console.log("Something wrong when updating data!");
//       }
  
//       console.log("successesful update");
//   });
...
//   return Recipe.deleteOne({ title: "Carrot Cake" }, function(err, result) {
//     if (err) {
//       console.log("Something wrong when updating data!");
//     } else {
